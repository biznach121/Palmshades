...
import { Yellowtail, Inter } from "next/font/google";
import "./globals.css";
...
// Palmshades wordmark face — a brush calligraphy script matching the logo.
// Exposed as --font-yellowtail; globals.css maps --font-display (and the
// `.font-kontanter` brand utility) onto it.
...
// Body/UI face. Exposed as --font-inter; globals.css maps --font-sans onto it.
const body = Inter({
  subsets: ["latin"],
  variable: "--font-inter",
  display: "swap",
